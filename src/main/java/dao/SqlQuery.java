...
public class SqlQuery {
    ...
    public static final String GET_ALL_LIKED_USERS = "select w.id,w.name, w.surname, w.job, w.last_login,  w.photo  ,null as email, null as password, DATE_PART('day', now() - w.last_login)  as day from liked l " +
